...
CREATE TABLE `log` (
  ...
  `user` text NOT NULL,
  `news` int(10) UNSIGNED NOT NULL COMMENT '紀錄id的數字'
...
INSERT INTO `que` (`id`, `text`, `subject_id`, `vote`) VALUES
(19, '123', 0, 0),
(20, '0', 19, 0),
(21, '0', 19, 0),
(22, '0', 19, 0);
...
INSERT INTO `visit` (`id`, `date`, `visit`) VALUES
(1, '2025-07-13', 1),
(2, '2025-07-15', 2),
(3, '2025-07-14', 37);
